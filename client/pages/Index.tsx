...
export default function Index() {
  return (
    ...
    >
      ...
      {/* Section 3: Dual AI Console */}
      <section id="dual-ai-console" className="relative py-20 overflow-hidden">
        <div
          className="absolute inset-0 parallax"
          style={{
            backgroundImage:
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-gray-300 text-lg font-light leading-relaxed mb-6">
                ...
                AI-triggered workflows, and intelligent client routing systems.
              </p>
