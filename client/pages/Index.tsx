      ...
      <div className="relative z-10">
        ...
        <section className="py-20 px-8">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-yellow-400 text-lg font-light tracking-wider mb-4">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
              <div className="space-y-6">
                <h3 className="text-yellow-400 text-2xl font-light">
                  Dual AI Console
                </h3>
                ...
                <div className="pt-6">
                  <Button className="bg-gradient-to-r from-yellow-400 to-yellow-300 text-gray-900 font-medium px-8 py-3 rounded-xl">
                    Try Dual Chat Mode
                  </Button>
                </div>
              </div>
              ...
              {/* Console Mockup */}
              <div className="bg-gray-900/60 backdrop-blur border border-yellow-400/20 rounded-2xl p-6">
        ...
        <section className="py-20 px-8 bg-gray-900/20">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              {/* PartnerTech Suite Visual */}
              <div className="bg-gray-900/40 backdrop-blur border border-blue-400/20 rounded-2xl p-8">
                <div className="text-center">
                  <h4 className="text-blue-400 text-lg font-medium mb-6">
                    PartnerTech Suite
                  </h4>
                  <div className="grid grid-cols-2 gap-6">
                    <div className="text-center">
                      ...
                      <span className="text-blue-400 text-sm">CRM</span>
                    </div>
                    <div className="text-center">
                      <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mx-auto mb-2">
                        <Zap className="w-6 h-6 text-blue-400" />
                      </div>
                      <span className="text-blue-400 text-sm">Chrome</span>
                    </div>
                    <div className="text-center">
                      <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mx-auto mb-2">
                        <Brain className="w-6 h-6 text-blue-400" />
                      </div>
                      <span className="text-blue-400 text-sm">Triggers</span>
                    </div>
                    <div className="text-center">
                      <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mx-auto mb-2">
                        <CheckCircle className="w-6 h-6 text-blue-400" />
                      </div>
                      <span className="text-blue-400 text-sm">AI Logic</span>
                    </div>
                  </div>
                  <div className="mt-4 text-xs text-gray-400">Premium Tier</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300 text-lg max-w-3xl mx-auto">
                <span className="text-green-400">Secure. Private. Moral.</span>{" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-gray-900/40 backdrop-blur border border-green-400/20 rounded-2xl p-6">
                <div className="text-center mb-6">
                  <Shield className="w-8 h-8 text-green-400 mx-auto mb-2" />
                  <h4 className="text-green-400 text-lg font-medium">
                    Protected Data Vault
                  </h4>
                </div>
        ...
        <section className="py-20 px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gray-900/40 backdrop-blur border border-yellow-400/20 rounded-2xl p-8 mb-12">
            ...
            <div className="space-y-4 max-w-md mx-auto">
              <Link to="/login">
                <Button className="w-full bg-gradient-to-r from-yellow-400 to-yellow-300 text-gray-900 font-medium py-6 text-lg rounded-xl">
